$(document).ready(function () {
    var topics = ['jordan', 'supreme', 'bape', 'stussy', 'off White', 'hypebeast', 'coachella'];
    ...
    $(document).on('click', '.expression', function () {
        ...
        var queryURL = "http://api.giphy.com/v1/gifs/search?q=" + car + "&api_key=fP6OEUpTtXaEOCj1TQyHYAYeWiYJpr1Z&limit=10";
